...
final class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		// 第一步注册所有实现了 PriorityOrdered 的 BeanPostProcessor
		// 先拍下
		sortPostProcessors(priorityOrderedPostProcessors, beanFactory);
		// 后注册
		...
		// 最后 注册所有的 MergedBeanDefinitonPostProcessor 类型的 BeanPostProcessor
		sortPostProcessors(internalPostProcessors, beanFactory);
		registerBeanPostProcessors(beanFactory, internalPostProcessors);

		// Re-register post-processor for detecting inner beans as ApplicationListeners,
		// moving it to the end of the processor chain (for picking up proxies etc).
		// 加入ApplicationListeenerDetector(探测器)
		// 重新注册 BeanPostProcessor 以坚持内部 bean, 因为 ApplicationListeners 将其移动到处理器链的末尾
